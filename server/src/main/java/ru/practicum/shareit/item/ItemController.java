...
public class ItemController {
    ...
    @PostMapping
    public ItemDto addItem(@RequestHeader(REQUEST_HEADER_VALUE) Long userId, @RequestBody ItemDto itemDto) {
    ...
    @PatchMapping("/{itemId}")
    public ItemDto updateItem(@RequestHeader(REQUEST_HEADER_VALUE) Long userId, @PathVariable Long itemId,
    ...
    @GetMapping("/{itemId}")
    public ItemWithBookingDto getItem(@RequestHeader(REQUEST_HEADER_VALUE) Long userId, @PathVariable Long itemId) {
